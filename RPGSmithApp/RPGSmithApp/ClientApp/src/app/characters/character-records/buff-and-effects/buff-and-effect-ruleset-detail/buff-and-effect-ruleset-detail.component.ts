...
@Component({
  selector: 'app-buff-and-effect-ruleset-detail',
  templateUrl: './buff-and-effect-ruleset-detail.component.html',
  styleUrls: ['./buff-and-effect-ruleset-detail.component.scss']
})

export class CharBuffAndEffectRulesetDetailsComponent implements OnInit {
