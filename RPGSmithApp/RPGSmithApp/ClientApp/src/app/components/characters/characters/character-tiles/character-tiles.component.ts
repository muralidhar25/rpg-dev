...
import { VIEW, TILES, STAT_TYPE, CONDITION_OPERATOR_ENUM } from '../../../../models/enums';
...
import { Box } from '../../../../models/tiles/box.model';
...
export class CharacterTilesComponent implements OnInit {
    ...
    createUpdateTileConfigList(configList: TileConfig[], update: boolean, redriectToCharacter: boolean = false, viewLoader: boolean = true) {
        if (update) {
