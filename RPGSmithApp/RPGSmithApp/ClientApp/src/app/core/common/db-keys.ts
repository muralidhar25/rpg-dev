...
export class DBkeys {
  ...
  public static readonly SOCIAL_LOGIN = "social_login";
  public static readonly RULESET_ID = "ruleset_id";
  public static readonly HEADER_VALUE = "header_value";
  public static readonly CHARACTER_ID = "character_id";
  ...
  public static readonly IsUpdatedByCharacter = "IsUpdatedByCharacter";
