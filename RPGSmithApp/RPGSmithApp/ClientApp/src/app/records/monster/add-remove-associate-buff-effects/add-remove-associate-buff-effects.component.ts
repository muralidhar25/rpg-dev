...
@Component({
  selector: 'app-add-remove-associate-buff-effects',
  templateUrl: './add-remove-associate-buff-effects.component.html',
  styleUrls: ['./add-remove-associate-buff-effects.component.scss']
})
