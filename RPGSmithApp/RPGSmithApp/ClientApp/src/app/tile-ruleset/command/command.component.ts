...
export class RulesetCommandTileComponent implements OnInit {
  ...
  ngOnInit() {
    setTimeout(() => {
      ...
      this.rulesetTileModel = this.commandTileService.commandTileRulesetModelData(model, this.rulesetId, this.pageId, view, this.pageDefaultData);
      this.commandTileFormModal = Object.assign({}, this.rulesetTileModel.commandTile);
      this.commandTileFormModal.color = this.rulesetTileModel.color;
      this.commandTileFormModal.shape = this.rulesetTileModel.shape;
        ...
        .subscribe(
          ...
          error => {
            ...
            if (Errors.sessionExpire) {
              this.authService.logout(true);
            } else this.addEditCommandTile(this.rulesetTileModel);
          });
    }
  }
  ...
  private addEditCommandTile(modal) {
    ...
    this.isLoading = true;
    this.commandTileService.createRulesetCommandTile(modal)
      .subscribe(
        data => {
          // console.log(data);
          this.isLoading = false;
