...
import { ToggleTile, TileToggle, CustomTileToggle } from '../../core/models/view-models/toggle-tile.model';
...
export class ToggleTileComponent implements OnInit {
  ...
  public event: EventEmitter<any> = new EventEmitter();
    ...
    customToggleViewModel = new CustomTileToggle();
  ...
  validateSubmit() {
    this.toggleTileFormModal.tileToggleViewModel = this.tileToggleViewModel;
          console.log(this.toggleTileFormModal);
        ...
        if (this.characterTileModel.characterId == 0 || this.characterTileModel.characterId == undefined) {
          ...
          this.toggleTileFormModal.title = this.toggleTileFormModal.title ? this.toggleTileFormModal.title.trim() : undefined;
                ...
                this.isLoading = true;
             let _msg = this.toggleTileFormModal.toggleTileId == 0 || this.toggleTileFormModal.toggleTileId === undefined ? "Creating Command Tile..." : "Updating Command Tile...";
  ...
  selectedToggle(toggleViewModel: TileToggle, type) {
    ...
    if (type === TOGGLE_TYPE.DISPLAY)
      ...
      toggleViewModel.customTileToggles = [];
      toggleViewModel.customTileToggles.push(
        { customToggleId: 0, image: '', toggleText: '' },
        { customToggleId: 0, image: '', toggleText: '' });
    }
  }
  addToggleImage(toggle: CustomTileToggle ) {
  ...
  removeToggle(toggle: CustomTileToggle ): void {
    this.tileToggleViewModel.customTileToggles
      .splice(this.tileToggleViewModel.customTileToggles.indexOf(toggle), 1);
  }
  showHidecustomFields() {
    this.showMoreLessColorToggle = !this.showMoreLessColorToggle;
  }
  addToggle(toggles: CustomTileToggle[]): void {
    toggles.push(
      { customToggleId: 0, image: '', toggleText: '' });
  }
