...
import { RulesetEndpoint } from "../../../core/services/ruleset-endpoint.service";
...
import { CharacterStats, ICON, ConditionOperator } from '../../../core/models/view-models/character-stats.model';
...
export class CharacterStatsComponent implements OnInit {
    ...
    constructor(
        ...
        private sharedService: SharedService, private dragulaService: DragulaService
    ) {
