...
export class ConfigurationService {
    ...
    //TODO-NJ: Base url can be hooked up from an interceptor in a clean way
    public baseUrl = environment.baseUrl || Utilities.baseUrl();
    public loginUrl = environment.loginUrl;
    public appVersion = environment.appVersion;
    public appBuildNo = environment.appBuildNo;
    public PublishedDate = environment.PublishedDate;
    public registerUrl = environment.registerUrl;

    public loginApi = environment.loginApi;
    public registerApi = environment.registerApi;
    public forgotPassApi = environment.forgotPassApi;
    public resetPassApi = environment.resetPassApi;
    public changePassApi = "/api/account/ChangePassword";

    public grantTypeFacebook = environment.grantType.facebook;
    public grantTypeGoogle = environment.grantType.google;

    //TODO-NJ: Base url can be hooked up from an interceptor in a clean way
    public fallbackBaseUrl = "https://app.rpgsmith.com";
