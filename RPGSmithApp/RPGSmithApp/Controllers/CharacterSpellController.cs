    ...
    public class CharacterSpellController : Controller
    {
       ...
       // [ProducesResponseType(200, Type = typeof(IEnumerable<CharacterSpell>))]
        ...
        public async Task<IActionResult> getByCharacterId_sp(int characterId, int rulesetId, int page = 1, int pageSize = 30)
        {
            ...
            (List<CharacterSpell> CharacterSpellList, Character _character, RuleSet _ruleSet) = _characterSpellService.SP_CharacterSpell_GetByCharacterId(characterId, rulesetId, page, pageSize);
