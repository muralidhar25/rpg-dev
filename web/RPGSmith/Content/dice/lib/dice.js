...
(function(dice) {
    ...
    this.dice_color = '#d15727';
    this.ambient_light_color = 0x58514c;
    this.spot_light_color = 0x58514c;
    this.selector_back_colors = { color: 0x58514c, shininess: 40, emissive: 0x58514c };
    this.desk_color = 0x58514c;
    ...
    this.dice_box.prototype.bind_customthrow = function(notation_getter, before_roll, after_roll) {
        var box = this;
        box.start_throw(notation_getter, before_roll, after_roll);
    }
