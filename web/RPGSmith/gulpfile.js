...
var vendorSrc = [
    ...
    'bower_components/ng-pageslide/dist/angular-pageslide-directive.js',
    'bower_components/ngImgCrop/compile/unminified/ng-img-crop.js',
    'bower_components/ngstorage/ngStorage.js',
    'bower_components/number-format.js/lib/format.js',
    ...
    'bower_components/tinymce/plugins/directionality/plugin.js',
    'bower_components/tinymce/plugins/emoticons/plugin.js',
    'bower_components/tinymce/plugins/hr/plugin.js',
    'bower_components/tinymce/plugins/insertdatetime/plugin.js',
    ...
    'bower_components/tinymce/plugins/visualblocks/plugin.js',
    'bower_components/tinymce/plugins/visualchars/plugin.js',
    'bower_components/tinymce/themes/modern/theme.js',
    'Content/colopicker/lib/color-picker.js',
    'Content/dice/lib/three.min.js',
    'Content/dice/lib/cannon.min.js',
    'Content/dice/lib/teal.js',
    'Content/dice/lib/dice.js'
]
...
gulp.task('vendor-bundle', function () {
    return gulp
        .src(vendorSrc, { base: 'bower_components/' })
        .pipe(plumber())
...
gulp.task('app-bundle', function () {
    ...
    var templates = gulp.src(templateSrc)
        .pipe(plumber())
