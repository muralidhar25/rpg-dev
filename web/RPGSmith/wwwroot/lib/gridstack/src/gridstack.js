...
(function(factory) {
    ...
    GridStack.prototype.cellWidth = function() {
        return this.opts.pixelWidth ? this.opts.pixelWidth : Math.round(this.container.outerWidth() / this.opts.width);
    };
    ...
    GridStack.prototype.getCellFromPixel = function(position, useOffset) {
        ...
        var columnWidth = this.opts.pixelWidth ? this.opts.pixelWidth
             : Math.floor(this.container.width() / this.opts.width);
